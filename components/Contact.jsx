...
import ContactImg from "../public/assets/grad-photo-dre.png";
      ...
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full ">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form
                action="https://getform.io/f/6ccca436-4789-4188-bb6e-5426959f3862"
                method="POST"
              ...
              >
                ...
                <button className="w-full p-4 text-gray-100 mt-4 hover:text-[#40C083] cursor-pointer hover:scale-105 ease-in duration-300">
                  Send Message
                </button>
              </form>
            </div>
