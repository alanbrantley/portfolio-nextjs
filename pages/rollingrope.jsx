      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:flex md:items-start gap-8 py-8">
        <div className="col-span-4 md:flex-grow">
          <h1 className="text-4xl mb-8">
            Rolling Rope - Handheld Back Massager Redesign
          </h1>

          <section>
            <h2 className="text-2xl mt-8">Context</h2>
            <p className="mt-2">
              The physical component of this project was originally developed as
              part of a four-week conceptualization and prototyping exercise in
              my first term at the USC. However, I was offered the opportunity
              to extend its development through the full term, allowing me to
              construct a high-fidelity prototype. Concurrently, within a visual
              design class I was enrolled in during that term, I produced the
              digital elements of the project. This involved creating a poster
          ...
          <section>
            ...
            <p className="mt-2">
              Modern handheld massagers are often bulky and inconvenient to use,
              lacking in portability and self-administration. Rolling Rope
              addresses this by offering an innovative, user-friendly design.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              As the sole designer and creator of Rolling Rope, I was
              responsible for all aspects of product development, from initial
              design to prototype testing and branding.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              The product underwent multiple design iterations in Fusion 360
              before arriving at the final design. The handles and rings were 3D
              printed and assembled together with wooden balls containing
              bearings.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc ml-5 mt-2">
              <li>
                Used Fusion 360 for design due to its versatility and accuracy
              </li>
              <li>3D printed parts for quick and cost-effective prototyping</li>
              <li>
                Chose a modern and minimalistic design language to fit with
          ...
          <section>
            ...
            <ul className="list-disc ml-5 mt-2">
              ...
              <li>
                Struggled with finding a balance between user comfort and
                mechanical functionality
              </li>
              <li>
                Had to account for the durability of 3D printed parts during use
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              The final prototype was able to provide distinct muscle relief and
          ...
          <section>
            ...
            <p className="mt-2">
              If I were to move forward with this project, my next steps would
              be to start a crowdfunding campaign to fund user research and
              production of a high-fidelity prototype. I would revise the logo
              and branding, implement the website, and begin a social media
              campaign while preparing for the production phase.
            </p>
          </section>
