      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:flex md:items-start gap-8 py-8'>
        <div className='col-span-4 md:flex-grow'>
          ...
          <section>
            ...
            <p className='mt-2'>Wrimo was a 4-week Speculative Design project for Aesthetics of Design II with Lisa Krohn at Iovine and Young Academy. The prompt was to imagine how humans might interact with technology 10 years into the future.</p>
          </section>

          <section>
            <h2 className='text-2xl mt-16'>How might we interact with technology in 10 years?</h2>
          ...
          <section>
            ...
            <p className='mt-2'>One of the constraints for this project was that it had a physical prototype requirement. This forced me away from the &quot;killer app&quot; mindset and toward thinking about how we interact with our world. Through weeks of iteration, experimentation, and pivots, I landed Wrimo, a wrist wearable universal remote with ground breaking shape shifting technology. Inspired by Shape-memory alloys, Wrimo&apos;s shape-shifting material interface and shape automatically shift to meet the user&apos;s immediate need. </p>
          ...
          <section>
            ...
            <p className='mt-2'>I generated the boxes using MidJourney, created the logo in Figma, and create the image in Photoshop. </p>
            <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 mt-8'>
          ...
          <section>
            ...
            <p className='mt-2'>I like to think my Photoshop skills have progressed since then.</p>
            <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 mt-8'>
          ...
          <section>
            ...
            <p className='mt-2'>Click the button below to read more about the users, solution, and process here. </p>
            <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 mt-8'>
