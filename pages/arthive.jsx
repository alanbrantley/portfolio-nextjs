        ...
        <div className="col-span-4 md:flex-grow">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              overwhelming. Traditional art galleries can be intimidating and
          ...
          <section>
            ...
            <ul className="list-disc ml-5 mt-2">
              ...
              <li>
                Art enthusiasts looking for a convenient and accessible way to
          ...
          <section>
            ...
            <p className="mt-2">
              We built a fully functional app using dummy data and front end
              coding. We started with a previous build as a starting point and
              created an app that allowed artists to share their work and get
              feedback.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc ml-5 mt-2">
              ...
              <li>
                Created a centralized marketplace specifically for artists and
                art enthusiasts
              </li>
              <li>
                Planned for future enhancements such as secure payments,
                community features, and a feedback channel
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc ml-5 mt-2">
              ...
              <li>
                Securing partnerships with artists, galleries and museums is
                challenging
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ArtHive is a feasible and desirable solution as it democratizes
              the art world and connects artists with a global audience.
            </p>
          </section>
